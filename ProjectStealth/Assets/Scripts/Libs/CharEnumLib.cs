public static class CharEnums
{
    ...
    public enum MasterState { DefaultState, ClimbState, RappelState, AttackState, VaultState, EvadeState, AirHang, AirDash };
...
public enum GadgetEnum { Bomb, RangedBomb, ElectroMagneticPulse, MagnetLink, Cloak, Hacker, RangedHacker };